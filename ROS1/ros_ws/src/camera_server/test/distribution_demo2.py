...
light_sources = [[0.125*x_max_robotarium*board_scale, 0.5*y_max_robotarium*board_scale],
                    [0.5*x_max_robotarium*board_scale, 0.75*y_max_robotarium*board_scale],
                    [0.75*x_max_robotarium*board_scale, 0.375*y_max_robotarium*board_scale]]
