...
{
  new (message_memory) robot_msgs::msg::Environment(_init);
}

void Environment_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_msgs::msg::Environment *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Environment_message_member_array[4] = {
  {
    ...
    offsetof(robot_msgs::msg::Environment, temp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_msgs::msg::Environment, pressure),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_msgs::msg::Environment, humidity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_msgs::msg::Environment, altitude),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Environment_message_members = {
  ...
  4,  // number of fields
  sizeof(robot_msgs::msg::Environment),
...
get_message_type_support_handle<robot_msgs::msg::Environment>()
{
  return &::robot_msgs::msg::rosidl_typesupport_introspection_cpp::Environment_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_msgs, msg, Environment)() {
  return &::robot_msgs::msg::rosidl_typesupport_introspection_cpp::Environment_message_type_support_handle;
}
