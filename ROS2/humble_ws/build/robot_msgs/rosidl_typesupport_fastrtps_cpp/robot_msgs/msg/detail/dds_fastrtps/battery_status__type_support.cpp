...
#include "robot_msgs/msg/detail/battery_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_msgs::msg::BatteryStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_msgs::msg::BatteryStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_msgs::msg::BatteryStatus *>(
    untyped_ros_message);
...
{
  return &robot_msgs::msg::typesupport_fastrtps_cpp::_BatteryStatus__handle;
}
