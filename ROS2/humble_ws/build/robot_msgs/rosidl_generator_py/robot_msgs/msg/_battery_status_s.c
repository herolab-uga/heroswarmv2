...
bool robot_msgs__msg__battery_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_msgs.msg._battery_status.BatteryStatus", full_classname_dest, 44) == 0);
  }
  robot_msgs__msg__BatteryStatus * ros_message = _ros_message;
  {  // voltage
...
PyObject * robot_msgs__msg__battery_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_msgs.msg._battery_status");
