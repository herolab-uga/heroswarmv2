...
#include "robot_msgs/msg/detail/distance_sensor__rosidl_typesupport_fastrtps_c.h"
...
using _DistanceSensor__ros_msg_type = robot_msgs__msg__DistanceSensor;
...
size_t get_serialized_size_robot_msgs__msg__DistanceSensor(
  const void * untyped_ros_message,
...
static uint32_t _DistanceSensor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_msgs__msg__DistanceSensor(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_msgs
size_t max_serialized_size_robot_msgs__msg__DistanceSensor(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_msgs__msg__DistanceSensor;
    is_plain =
      (
...
static size_t _DistanceSensor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_msgs__msg__DistanceSensor(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_msgs, msg, DistanceSensor)() {
